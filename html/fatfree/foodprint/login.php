                ...
                <div class="card-body">
                    ...
                    <form method="POST">
                        <div class="input-group">
                            <input class="input--style-2" type="text" size="50" placeholder="Name/Email" name="name">
                        </div>
                        <div class="input-group">
                            <input class="input--style-2" type="password" size="50" placeholder="Password" name="password">
                        </div>
                        <div class="row row-space">
                        <div class="p-t-30">
                            <button class="btn btn--radius btn--green" type="submit"><a class="anchor" href="/~s1884908/fatfree/foodprint/">Submit</a></button>
                        </div>
                    </form>
                </div>
            </div>
